            ...
            if has_all and has_summary:
                ...
                if abs(home_prob - 0.5) < 0.01 and abs(away_prob - 0.5) < 0.01:
                    ...
                    home_advantage_map = {
                        ...
                        'CPBL': 0.47,  # 2026-09-03 主場優勢基準下調至 0.47（客隊略佔優勢，近30天主隊勝率僅41%）
                ...
                elif (features.get('league') or '').upper() == 'CPBL' and 0.45 <= home_prob <= 0.60:
                    # 🆕 [2026-09-03] CPBL 主場優勢系統性校正（數據驅動）
                    # 近 30 天主隊勝率僅 41.2%（客隊優勢），原 0.55 主隊略佔優方向相反
                    # 觸發範圍 0.45~0.60，強制校正為客隊略佔優勢
                    home_prob = 0.45
                    away_prob = 0.55
