...
- **主場優勢請以 Step 2 的實際對比為主，不要因「主場」一詞就額外加分**
  ...
  - **🆕 關鍵邊界規則**：MLB 歷史主場勝率 ~54%，整體勝負天平在主場方略傾。若雙方實力接近（各維度差距不大，無任一隊壓倒性優勢），**主場應作為 tiebreaker**：即使客隊在某些指標（投手或牛棚）略有優勢，若整體戰績/排名/打線/主客場等因素綜合後五五波，home_win_probability 應在 0.50-0.55 而非 0.40-0.50。切勿因為單一指標稍微偏好客隊就將主隊勝率壓到 0.40 以下。
