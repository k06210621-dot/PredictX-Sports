...
- MLB: ~53-54%  |  NPB: ~53-55%  |  CPBL: ~45%（客隊略佔優勢）  |  NBA: ~60%
...
- **主場優勢請以 Step 2 的實際對比為主，不要因「主場」一詞就額外加分**
  ...
  - **🆕 關鍵邊界規則**：MLB 歷史主場勝率 ~54%。五五波對戰中，主場為合理的 tiebreaker，給主隊 +0.02 ~ +0.04 微調。但若客隊在多數維度（投手、打線、牛棚）確實略佔上風，則不適用此規則 — 此時 home_win_probability 在 0.45-0.50 是合理的。此規則僅在「雙方數據無法明確分出優劣」時啟動。
