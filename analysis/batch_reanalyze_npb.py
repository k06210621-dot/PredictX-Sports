#!/usr/bin/env python3
"""
重新分析所有 NPB 已完賽事 — 使用 baseball-data.com 即時數據
"""
...
print(f"Re-analyzing {len(games)} NPB completed games with live data...\n")
...
engine.close()
elapsed = time.time() - start
print(f"\nDone! {success}/{len(games)} NPB games in {elapsed:.0f}s")