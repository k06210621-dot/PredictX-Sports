...
struct FAQSection: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            // AI 預測相關
            FAQCategory(title: "AI 預測相關", icon: "cpu.fill", iconColor: .blue) {
                FAQItem(question: "AI 勝率是如何計算的？") {
                    Text("AI 勝率是根據即時數據（球隊近況、對戰紀錄、投手/打擊數據、天氣等 50+ 項特徵）輸入本地語言模型後，經由 Prompt 推論得出的預測結果。系統會持續與實際比賽結果比對，計算長期命中率。")
                }
                FAQItem(question: "AI 信心值代表什麼？") {
                    Text("信心值為 1-10 的整數評分，代表 AI 模型對該場預測的確信程度。信心值越高（≥8），表示模型掌握的數據越充分、勝負傾向越明確。僅信心值 ≥9 的預測才會顯示於「高信心指數」焦點區。")
                }
                FAQItem(question: "為什麼預測結果會改變？") {
                    Text("賽前數據會持續更新（例如先發投手變動、最新傷兵消息、天氣變化等），AI 模型會根據最新的即時數據重新分析，因此預測結果可能隨時間微調。")
                }
                FAQItem(question: "為什麼實際比賽結果和預測不同？") {
            ...
            FAQCategory(title: "會員相關", icon: "crown.fill", iconColor: .yellow) {
                FAQItem(question: "Premium 會員有哪些功能？") {
                    Text("Premium 會員可享有：① AI 賽事分析可全部查看 ② 高信心指數預測查看 ④ 歷史命中率圖表 ⑤ 無廣告體驗。更多功能將陸續推出。")
                }
            ...
            FAQCategory(title: "資料相關", icon: "doc.text.fill", iconColor: .orange) {
                ...
                FAQItem(question: "支援哪些聯賽？") {
                    Text("目前支援：MLB（美國職棒）、NPB（日本職棒）、CPBL（中華職棒）、NBA（美國職籃）。世界盃足球賽事預計於開幕後納入。更多聯賽將陸續新增。")
                }
