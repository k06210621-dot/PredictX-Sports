        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            FAQCategory(title: "AI 預測相關", icon: "cpu.fill", iconColor: .blue) {
                FAQItem(question: "AI 勝率是如何計算的？") {
                    Text("AI 勝率是根據即時數據（球隊近況、對戰紀錄、投手/打擊數據、天氣等 50+ 項特徵）輸入本地語言模型後，經由 Prompt 推論得出的預測結果。系統會持續與實際比賽結果比對，計算長期驗證率。")
                }
                FAQItem(question: "AI 信心值代表什麼？") {
                    Text("信心值為 1-10 的整數評分，代表 AI 模型對該場預測的確信程度。信心值越高（≥8），表示模型掌握的數據越充分、勝負傾向越明確。僅信心值 ≥9 的預測才會顯示於「AI 重點觀察賽事」焦點區。")
                }
